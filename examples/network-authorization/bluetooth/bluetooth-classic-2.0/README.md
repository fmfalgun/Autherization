# Bluetooth 2.0 + EDR Authorization Policy

Authorization policy for Bluetooth 2.0 + EDR - Enhanced Data Rate

## Overview

This policy implements authorization controls for Bluetooth 2.0 + EDR, ensuring:
...
# Query policy
curl -X POST http://localhost:8181/v1/data/bluetooth_classic_2.0/allow \
