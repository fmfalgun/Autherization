...
Authorization policy for Bluetooth 3.0 + HS - High Speed

## Overview

This policy implements authorization controls for Bluetooth 3.0 + HS, ensuring:
...
# Query policy
curl -X POST http://localhost:8181/v1/data/bluetooth_classic_3.0/allow \
