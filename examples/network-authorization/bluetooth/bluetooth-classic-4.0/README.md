# Bluetooth 4.0 Authorization Policy

Authorization policy for Bluetooth 4.0 - Low Energy introduced

## Overview

This policy implements authorization controls for Bluetooth 4.0, ensuring:
...
# Query policy
curl -X POST http://localhost:8181/v1/data/bluetooth_classic_4.0/allow \
