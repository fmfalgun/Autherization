# Bluetooth 5.0 Authorization Policy

Authorization policy for Bluetooth 5.0 - Long range and mesh

## Overview

This policy implements authorization controls for Bluetooth 5.0, ensuring:
...
# Query policy
curl -X POST http://localhost:8181/v1/data/bluetooth_classic_5.0/allow \
