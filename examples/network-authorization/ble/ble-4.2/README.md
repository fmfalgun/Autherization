# BLE 4.2 Authorization Policy

Authorization policy for BLE 4.2 - Privacy and security enhancements

## Overview

This policy implements authorization controls for BLE 4.2, ensuring:
...
# Query policy
curl -X POST http://localhost:8181/v1/data/ble_4.2/allow \
