# BLE 5.1 Authorization Policy

Authorization policy for BLE 5.1 - Direction finding

## Overview

This policy implements authorization controls for BLE 5.1, ensuring:
...
# Query policy
curl -X POST http://localhost:8181/v1/data/ble_5.1/allow \
