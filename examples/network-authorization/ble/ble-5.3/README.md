# BLE 5.3 Authorization Policy

Authorization policy for BLE 5.3 - Connection improvements

## Overview

This policy implements authorization controls for BLE 5.3, ensuring:
...
# Query policy
curl -X POST http://localhost:8181/v1/data/ble_5.3/allow \
