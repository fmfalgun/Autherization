# BLE 4.0 Authorization Policy

Authorization policy for BLE 4.0 - First BLE specification

## Overview

This policy implements authorization controls for BLE 4.0, ensuring:
...
# Query policy
curl -X POST http://localhost:8181/v1/data/ble_4.0/allow \
