# BLE 5.2 Authorization Policy

Authorization policy for BLE 5.2 - LE Audio and EATT

## Overview

This policy implements authorization controls for BLE 5.2, ensuring:
...
# Query policy
curl -X POST http://localhost:8181/v1/data/ble_5.2/allow \
