# BLE 5.4 Authorization Policy

Authorization policy for BLE 5.4 - Advertising enhancements

## Overview

This policy implements authorization controls for BLE 5.4, ensuring:
...
# Query policy
curl -X POST http://localhost:8181/v1/data/ble_5.4/allow \
