# BLE 4.1 Authorization Policy

Authorization policy for BLE 4.1 - Coexistence improvements

## Overview

This policy implements authorization controls for BLE 4.1, ensuring:
...
# Query policy
curl -X POST http://localhost:8181/v1/data/ble_4.1/allow \
