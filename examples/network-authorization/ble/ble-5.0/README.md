# BLE 5.0 Authorization Policy

Authorization policy for BLE 5.0 - 2x speed, 4x range, 8x advertising

## Overview

This policy implements authorization controls for BLE 5.0, ensuring:
...
# Query policy
curl -X POST http://localhost:8181/v1/data/ble_5.0/allow \
