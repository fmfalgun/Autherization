# LoRa Class A Authorization Policy

Authorization policy for LoRa Class A - Bi-directional, lowest power

## Overview

This policy implements authorization controls for LoRa Class A, ensuring:
...
# Query policy
curl -X POST http://localhost:8181/v1/data/lora_class_a/allow \
