# LoRa Class C Authorization Policy

Authorization policy for LoRa Class C - Continuous listening

## Overview

This policy implements authorization controls for LoRa Class C, ensuring:
...
# Query policy
curl -X POST http://localhost:8181/v1/data/lora_class_c/allow \
