# LoRa Class B Authorization Policy

Authorization policy for LoRa Class B - Scheduled receive slots

## Overview

This policy implements authorization controls for LoRa Class B, ensuring:
...
# Query policy
curl -X POST http://localhost:8181/v1/data/lora_class_b/allow \
