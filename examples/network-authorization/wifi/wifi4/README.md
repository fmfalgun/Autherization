# WiFi 4 (802.11n) Authorization Policy

Authorization policy for WiFi 4 (802.11n) - High Throughput with MIMO

## Overview

This policy implements authorization controls for WiFi 4 (802.11n), ensuring:
...
# Query policy
curl -X POST http://localhost:8181/v1/data/wifi4/allow \
