# WiFi Ad-hoc Mode Authorization Policy

Authorization policy for WiFi Ad-hoc Mode - Peer-to-peer WiFi networks

## Overview

This policy implements authorization controls for WiFi Ad-hoc Mode, ensuring:
...
# Query policy
curl -X POST http://localhost:8181/v1/data/wifi_adhoc/allow \
