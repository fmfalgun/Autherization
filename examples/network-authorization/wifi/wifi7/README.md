# WiFi 7 (802.11be) Authorization Policy

Authorization policy for WiFi 7 (802.11be) - Extremely High Throughput with MLO

## Overview

This policy implements authorization controls for WiFi 7 (802.11be), ensuring:
...
# Query policy
curl -X POST http://localhost:8181/v1/data/wifi7/allow \
