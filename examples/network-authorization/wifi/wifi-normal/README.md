# WiFi Normal (802.11b/g) Authorization Policy

Authorization policy for WiFi Normal (802.11b/g) - 2.4GHz basic WiFi with WPA2

## Overview

This policy implements authorization controls for WiFi Normal (802.11b/g), ensuring:
...
# Query policy
curl -X POST http://localhost:8181/v1/data/wifi_normal/allow \
