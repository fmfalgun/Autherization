# WiFi Enterprise Authorization Policy

Authorization policy for WiFi Enterprise - WPA2/WPA3-Enterprise with RADIUS

## Overview

This policy implements authorization controls for WiFi Enterprise, ensuring:
...
# Query policy
curl -X POST http://localhost:8181/v1/data/wifi_enterprise/allow \
