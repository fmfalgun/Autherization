...
Authorization policy for OpenZiti Service Auth - Zero trust service access

## Overview

This policy implements authorization controls for OpenZiti Service Auth, ensuring:
...
# Query policy
curl -X POST http://localhost:8181/v1/data/openziti_service_authorization/allow \
