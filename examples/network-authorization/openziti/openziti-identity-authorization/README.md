...
Authorization policy for OpenZiti Identity Auth - Identity-based authorization

## Overview

This policy implements authorization controls for OpenZiti Identity Auth, ensuring:
...
# Query policy
curl -X POST http://localhost:8181/v1/data/openziti_identity_authorization/allow \
