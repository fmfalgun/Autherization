# Zero Trust Device Trust Authorization Policy

Authorization policy for Zero Trust Device Trust - Device posture validation

## Overview

This policy implements authorization controls for Zero Trust Device Trust, ensuring:
...
# Query policy
curl -X POST http://localhost:8181/v1/data/zero_trust_device_trust/allow \
