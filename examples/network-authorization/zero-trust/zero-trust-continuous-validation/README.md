# Zero Trust Continuous Validation Authorization Policy

Authorization policy for Zero Trust Continuous Validation - Ongoing verification

## Overview

This policy implements authorization controls for Zero Trust Continuous Validation, ensuring:
...
# Query policy
curl -X POST http://localhost:8181/v1/data/zero_trust_continuous_validation/allow \
