# Zigbee PRO Authorization Policy

Authorization policy for Zigbee PRO - Professional features

## Overview

This policy implements authorization controls for Zigbee PRO, ensuring:
...
# Query policy
curl -X POST http://localhost:8181/v1/data/zigbee_pro/allow \
