...
Authorization policy for Zigbee 3.0 - Unified standard

## Overview

This policy implements authorization controls for Zigbee 3.0, ensuring:
...
# Query policy
curl -X POST http://localhost:8181/v1/data/zigbee_3.0/allow \
