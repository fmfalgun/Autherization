# LoRaWAN 1.0 Authorization Policy

Authorization policy for LoRaWAN 1.0 - Initial specification

## Overview

This policy implements authorization controls for LoRaWAN 1.0, ensuring:
...
# Query policy
curl -X POST http://localhost:8181/v1/data/lorawan_1.0/allow \
