...
Authorization policy for LoRaWAN 1.0.4 - Latest 1.0.x

## Overview

This policy implements authorization controls for LoRaWAN 1.0.4, ensuring:
...
# Query policy
curl -X POST http://localhost:8181/v1/data/lorawan_1.0.4/allow \
