# SPIRE SVID Authorization Authorization Policy

Authorization policy for SPIRE SVID Authorization - X.509 SVID validation

## Overview

This policy implements authorization controls for SPIRE SVID Authorization, ensuring:
...
# Query policy
curl -X POST http://localhost:8181/v1/data/spire_svid_authorization/allow \
