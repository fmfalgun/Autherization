...
Authorization policy for SPIRE Workload Attestation - Verify workload identity

## Overview

This policy implements authorization controls for SPIRE Workload Attestation, ensuring:
...
# Query policy
curl -X POST http://localhost:8181/v1/data/spire_workload_attestation/allow \
